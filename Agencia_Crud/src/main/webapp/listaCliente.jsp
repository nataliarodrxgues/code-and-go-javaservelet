            ...
            <tbody>
                <c:forEach items="${clientes}" var="cliente">
                    <tr>
                        ...
                        <td>
                            <a href="UpdateController?id_Cliente=${cliente.id_Cliente}" class="btn btn-success">Editar</a>
                            <a href="DeleteController?id_Cliente=${cliente.id_Cliente}" class="btn btn-danger">Excluir</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
