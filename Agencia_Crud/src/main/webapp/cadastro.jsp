...
<!--NavBar-->
  <div class="shadow p-3 mb-5 bg-white rounded">
    ...
    <!--Mensagem da página-->
    <div>
    <h1 style="color: #ffc107;" id="fontetitle">Cadastre-se aqui:</h1>
    <hr class="my-4">
    </div>
        ...
        <div class="jumbotron">
            ...
            <form class="mt-5" action="CreateController" method="post">
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
							class="form-control" id="CPF_Cliente" name="CPF_Cliente" placeholder="XXX.XXX.XXX-XX"required>   
                    </div>

                    <div class="form-group mb-3">
                        <label for="nome_Cliente">Nome</label>
                        <input type="text"
							class="form-control" id="nomeCliente" name="nome_Cliente" placeholder="Escreva aqui seu nome" required>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text"
							class="form-control" id="email_Cliente" name="email_Cliente" placeholder="Escreva aqui seu email" required>
                    </div>
                    <div class="form-row mb-2" style="display: flex; gap: 20px">
                        <div class="form-group col-md-5 mb-3">
                            <label for="telefone_Cliente">Telefone</label>
                            <input type="text"
							class="form-control" id="telefone_Cliente" name="telefone_Cliente" placeholder="(xx) xxxxx-xxxx" required>
                        ...
                        <div class="form-group col-md-7 mb-3">
                            ...
                            <input type="password"
							class="form-control" id="senha_Cliente" name="senha_Cliente" placeholder="Digite sua senha"required>                     
                        </div>
                        <div></div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
							class="form-control" id="endereco_Cliente" name="endereco_Cliente" placeholder="Digite seu endereço" required>
    ...
    <div class="container-fluid bg-dark text-white-50 py-sm-1 px-sm-1 px-sm-5" style="margin-top: 50px">
        <p class="text-white text-right" style="text-align: center"><img src="IMG/logo_rodape.png"
                alt="Code & Go! Viagens" style="width: 10%;">
